...
* The Photo in screenshot.png is from stocksnap.io, and licensed Creative Commons 0 (CC0)
Stocksnap - Distributed under the terms of CC0 1.0 Universal License (Public Domain).
...
* Version compatibility for WP 6.8 & WC 10

#### 1.3.40
* Styling fixes/tweaks
* Simplified theme admin notes
* Version compatibility for WP 6.2 & WC 7.6
* Updated the language .pot file

#### 1.3.36
* Styling fixes/tweaks
* Added setting to edit Mobile menu text
* Updated the language .pot file

#### 1.3.35
* Styling fixes/tweaks
* Compatibility check with new WP & WooCommerce
* Version bump update
